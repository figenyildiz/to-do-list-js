// Html Sayfasındaki elementlerin seçilmesi:
...
//Mevcut Listeyi Oluşturmak İçin Çarpı Butonunun Oluşturulması:
...
function elemanEkle() {
   ...
   //Sonradan Eklenen Maddeleri Eklemek İçin Aynı İşlemlerin Tekrarı: 
   liDOM.onclick = check;
